...
local bytecode = {{5, "game"},{8, "GetService"},{1, "Players"},{3, 1},{4, "Players"},{5, "game"},{8, "GetService"},{1, "ReplicatedStorage"},{3, 1},{4, "ReplicatedStorage"},{5, "game"},{8, "GetService"},{1, "RunService"},{3, 1},{4, "RunService"},{5, "Players"},{6, "LocalPlayer"},{4, "player"},{5, "ReplicatedStorage"},{8, "WaitForChild"},{1, "GrabEvents"},{3, 1},{8, "WaitForChild"},{1, "CreateGrabLine"},{3, 1},{5, "UI"},{18, 0},{10, 0},{4, "grabEvent"},{5, "Instance"},{6, "new"},{1, "ScreenGui"},{3, 1},{4, "screenGui"},{5, "screenGui"},{1, "MapWideSpamUI"},{7, "Name"},{5, "screenGui"},{1, false},{7, "ResetOnSpawn"},{5, "screenGui"},{5, "player"},{8, "WaitForChild"},{1, "PlayerGui"},{3, 1},{7, "Parent"},{5, "Instance"},{6, "new"},{1, "TextButton"},{3, 1},{4, "toggleBtn"},{5, "toggleBtn"},{5, "UDim2"},{6, "new"},{1, 0},{1, 250},{1, 0},{1, 60},{3, 4},{7, "Size"},{5, "toggleBtn"},{5, "UDim2"},{6, "new"},{1, 0.5},{1, 125},{18, 0},{1, 0.85},{1, 0},{3, 4},{7, "Position"},{5, "toggleBtn"},{5, "Color3"},{6, "fromRGB"},{1, 20},{1, 20},{1, 20},{3, 3},{7, "BackgroundColor3"},{5, "toggleBtn"},{5, "Color3"},{6, "new"},{1, 1},{1, 1},{1, 1},{3, 3},{7, "TextColor3"},{5, "toggleBtn"},{5, "Enum"},{6, "Font"},{6, "SourceSansBold"},{7, "Font"},{5, "toggleBtn"},{1, 24},{7, "TextSize"},{5, "toggleBtn"},{1, "MAP ALL SPAM: OFF"},{7, "Text"},{5, "toggleBtn"},{5, "screenGui"},{7, "Parent"},{5, "Instance"},{6, "new"},{1, "UICorner"},{3, 1},{4, "corner"},{5, "corner"},{5, "UDim"},{6, "new"},{1, 0},{1, 15},{3, 2},{7, "CornerRadius"},{5, "corner"},{5, "toggleBtn"},{1, nil},{18, 0},{10, 0},{7, "Parent"},{1, false},{4, "active"},{5, "CFrame"},{6, "new"},{1, 0.939641953},{18, 0},{1, 0.372039795},{1, 0.499999046},{18, 0},{1, 0.106275439},{18, 0},{1, 0},{1, 0.994336784},{18, 0},{1, 1.18534182e-07},{18, 0},{1, 1},{1, 1.26690196e-08},{1, 0.994336784},{1, 5.96046448e-08},{1, 0.106275439},{18, 0},{3, 12},{4, "targetCFrame"},{1, 2000},{1, 1},{18, 0},{10, 0},{5, "RunService"},{6, "Heartbeat"},{8, "Connect"},{15, {params={"dt",}, code={{5, "active"},{17, 0},{14, 1},{16, 0},{1, 1},{18, 0},{18, 0},{5, "math"},{6, "ceil"},{5, "targetFrequency"},{5, "dt"},{11, 0},{3, 1},{1, nil},{18, 0},{10, 0},{4, "batchSize"},{5, "Players"},{8, "GetPlayers"},{3, 0},{4, "allPlayers"},{1, 1},{4, "i"},{5, "target"},{4, "_"},{5, "target"},{6, "Character"},{4, "char"},{5, "char"},{14, 31},{5, "R6"},{18, 0},{18, 0},{5, "Torso"},{5, "R15"},{5, "UpperTorso"},{5, "HumanoidRootPart"},{5, "char"},{8, "FindFirstChild"},{1, "Torso"},{3, 1},{5, "char"},{8, "FindFirstChild"},{1, "UpperTorso"},{3, 1},{23, 0},{5, "char"},{8, "FindFirstChild"},{1, "HumanoidRootPart"},{3, 1},{23, 0},{4, "targetPart"},{5, "targetPart"},{14, 7},{5, "grabEvent"},{8, "FireServer"},{5, "targetPart"},{5, "targetCFrame"},{3, 2},{18, 0},{18, 0},{13, -37},{13, -40},{0, 0},}}},{3, 1},{18, 0},{10, 0},{5, "toggleBtn"},{6, "MouseButton1Click"},{8, "Connect"},{15, {params={}, code={{5, "active"},{17, 0},{4, "active"},{5, "active"},{14, 11},{5, "toggleBtn"},{1, "MAP ALL SPAM: ON"},{7, "Text"},{5, "toggleBtn"},{5, "Color3"},{6, "fromRGB"},{1, 150},{1, 0},{1, 0},{3, 3},{7, "BackgroundColor3"},{0, 0},}}},{3, 1},{18, 0},{10, 0},{4, "targetFrequency"},{0, 0},}
